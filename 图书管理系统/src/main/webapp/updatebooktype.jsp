...
<div class="container">
    <div class="row">
        ...
        <div class="col-md-4">
            <h2>图书类别编辑</h2>
            <form action="/BookType/update.do" method="post" style="margin-top:100px;left: 20px;">
                <div class="form-group">
                    <label for="bType">图书类别名称</label>
                    <input type="text" class="form-control" name="bType" value="${booktype.bType}" />
                </div>
                <div class="form-group" style="margin-left: 220px;margin-top: -74px;">
                    <label for="tNum">总数量</label>
                    <input type="text" class="form-control" name="tNum" value="${booktype.tNum}" />
                </div>
