        ...
        <div class="col-md-8 col-md-offset-1">
            ...
            <table class="table table-responsive-md  table-hover table-bordered" style="font-size: 15px;text-align: center;">
                ...
                <tr>
                    ...
                    <td>${reader1.sName}</td>
                    <td>${reader1.sSex}</td>
                    <td>${reader1.sClass}</td>
                    <td>${reader1.sBnum}</td>
                    <td>
                        <button class="btn btn-primary"><a href="/Reader/${reader1.sId}/updatereader.do">编辑</a></button>
                        <button class="btn btn-danger"><a href="/Reader/${reader1.sId}/delete.do">删除</a></button>
                    </td>
                </tbody>
            </table>
        </div>
